...
import { AdminEditPropertyPhotoCard } from "../../../../components/AdminComponents/admin_edit_property_photo_card";

export default function AdminEditPropertyPhotos() {
    ...
    */
    const handleRemovePhoto = (photoId, filename) => {
        ...
        showModal('AdminEditPropertyDelPhotoModal1', {
            photo: photoToRemove,
    ...
    const handleRemovePhotoPost = (photoId, filename) => { 
        ...
        axiosClient.post('/general-remove-published-property-photo', formData)
        .then(({data}) => {
            if(data.status === 200) {
    ...
    */
    const handleAddPhoto = () => {
        setAddPhotos([]);
        showModal('AdminEditPropertyAddPhotoModal1', {
    ...
    const handleAddPhotosPost = () => {
        ...
        axiosClient.post('/general-add-published-property-photo', formData)
        .then(({data}) => {
            if(data.status === 200) {                
    ...
    */
    ...
    const handleDragEnd = (event) => { 
        ...
        setPhotos(photos => {
            ...
            axiosClient.post('/general-update-published-property-photo-sequence', formData)
            return photos;
        })
    }
