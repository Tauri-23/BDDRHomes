...
export default function AdminEditPropertyDescription() {
    ...
    const handleSaveBtn = () => {
        ...
        axiosClient.post('/general-update-published-property-desc', formData)
        .then(({data}) => {
            if(data.status === 200) {
                setListing((propDesc) => {
                    const updatedDescription = {...propDesc};
                    updatedDescription[0].description = _description;
