...
export const AgentListingOptionModal1 = ({listing, handleRemovePropertyConfirmation, onClose }) => {
    return(
        <div className= {`modal1`}>
            <div className="modal-box3" key={listing.id}>
                ...
                <div className="d-flex flex-direction-y gap3">
                    ...
                    <div onClick={() => handleRemovePropertyConfirmation(listing)} className="secondary-btn-black2 text-center d-flex gap3 align-items-center justify-content-center">
                        <Icon.Trash3Fill/>
                        Remove Listing
                    </div>
                </div>
