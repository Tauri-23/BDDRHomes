        ...
        .then(({data}) => {
            if(data.status === 200) {
                ...
                setListing((listing) =>{
                    ...
                    updatedFloorplan.data[0].bath = _bath;
                    updatedFloorplan.data[0].carport = _carport;
                    updatedFloorplan.data[0].lot_area = _lotArea;
                    updatedFloorplan.data[0].floor_area = _floorArea;
