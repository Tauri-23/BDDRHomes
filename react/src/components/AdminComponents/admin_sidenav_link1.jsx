...
export const AdminSidenavLink1 = ({isSidenavOpen, label, path, activeLoc}) => {
    ...
    const icons = {
        ...
        'Teams & Agents': `/src/assets/media/icons/teamwork${activeLoc.some(active =>  pathname.includes(active)) ? '-fill-white' : ''}.svg`,
        'Agents': `/src/assets/media/icons/realtor${activeLoc.some(active =>  pathname.includes(active)) ? '-fill-white' : ''}.svg`,
        'Properties & Developers': `/src/assets/media/icons/home${activeLoc.some(active =>  pathname.includes(active)) ? '-fill-white' : ''}.svg`,
